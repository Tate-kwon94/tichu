 ...
 */
// 서버(빈자리 봇)와 클라이언트(혼자 연습) 공용 (UMD) — ml/endgame.js는 이 파일의 심(shim)
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('./tichu-core.js'), require('./bots.js'));
  } else {
    root.TichuEndgame = factory(root.TichuCore, root.TichuBots);
  }
}(typeof self !== 'undefined' ? self : this, function (C, B) {
'use strict';
...
return { solve: solve, endgameMove: endgameMove, maxHand: maxHand };
}));
