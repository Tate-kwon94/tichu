...
module.exports = { candidates: candidates, features: features, DIM: 17 };
...
if (require.main === module) {
  ...
  lines.forEach(function (line) {
    ...
    var cands = candidates(d.h);
    if (cands.length !== d.ev.length) return;            // 후보 공간 불일치 라벨은 버림
    var X = cands.map(function (c) { return features(d.h, c); });
